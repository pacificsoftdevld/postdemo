...
const HeaderSearchComponent = ({
	...
	return (
		<div className={`search ${className}`}>
			...
			<input className="search__input" type="text" placeholder="Search for posts" ref={inputSearchRef} onKeyUp={handleKeyUpSearch} />
				...
				<div className="search__result">
					<div className="search__result__head">
						<div className="key_search">
							<h2>{keySearch}<span className="btn_close_search" onClick={handleRemoveSearchKey}>×</span></h2>
