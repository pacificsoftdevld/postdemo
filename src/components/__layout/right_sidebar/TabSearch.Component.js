	...
	return (
		<div className={`tab ${className}`}>
			...
			<div className="tab__search">
				...
				<input className="input" type="text" ref={inputSearchRef} placeholder={placeholderSearch} onKeyUp={handleKeyUpSearch} />
				<button className="btn__options" onClick={handleOptions}>...</button>
			</div>
			<div className="tab__result">
				{children}
			</div>
			<button className="btn__show_more" onClick={handleShowMore}><i className="material-icons">keyboard_arrow_down</i></button>
		</div>
	)
}
