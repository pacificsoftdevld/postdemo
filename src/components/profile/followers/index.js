...
import avatar                    from '../../../styles/assets/imgs/users/kim.png'
...
export default class Followers extends React.Component {
	...
	render() {
		return (
			<div className="usercard_container followers_container clearfix">
				{
					this.dummyData.map(user => {
						return (
							<div key={user.user_id} className="user_profile">
								...
								<span className="user_profile__rate">{user.rate.toLocaleString()}</span>
